...
Nunca commite `.env`: ele pode conter chaves de API, tokens e identificadores de conta. O arquivo `.env.example` deve permanecer apenas com placeholders e exemplos seguros.
...
| `FASTFOREX_API_KEY` | Chave para consultar dados reais da FastForex. | Obrigatoria quando usar FastForex em dados reais | `replace-with-fastforex-api-key` |
...
| Variavel | Uso | Obrigatoriedade | Exemplo seguro |
| --- | --- | --- | --- |
| `TWELVE_DATA_API_KEY` | Chave da Twelve Data. | Obrigatoria para Twelve Data | `replace-with-twelvedata-api-key` |
...
| Variavel | Uso | Obrigatoriedade | Exemplo seguro |
| --- | --- | --- | --- |
| `MASSIVE_API_KEY` | Chave da API Massive/Polygon. | Obrigatoria para Massive | `replace-with-massive-api-key` |
...
| Variavel | Uso | Obrigatoriedade | Exemplo seguro |
| --- | --- | --- | --- |
| `OANDA_API_TOKEN` | Token da API OANDA. | Obrigatoria para OANDA | `replace-with-oanda-api-token` |
| `OANDA_ACCOUNT_ID` | ID da conta OANDA. | Obrigatoria para OANDA | `replace-with-oanda-account-id` |
...
- Preencha somente as credenciais do provedor de dados usado em producao.
